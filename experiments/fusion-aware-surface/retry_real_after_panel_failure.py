...
PUBLIC_PLAN_COMMIT = "6540d1044cecf3a9a686daf207b2362c37be66a3"
PUBLIC_DELIVERY_COMMIT = "012b0bb0587a217f737edb4176469bfde776ae60"
...
def receipt_payload(
    *,
    ...
    return {
        "schema_version": "1.0",
        "status": "accelerated real v5 accepted; completed synthetic v4 retained sealed",
        "package_index": {
...
def main() -> int:
    ...
    if version != 5:
        raise RuntimeError("accelerated real retry did not create version 5")
    ...
    print(
        "ACCELERATED_REAL_RETRY_ACCEPTED version=5 "
